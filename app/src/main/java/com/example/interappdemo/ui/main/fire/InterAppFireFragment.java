...
public class InterAppFireFragment extends DaggerFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buttonSend.setOnClickListener(v -> {
            if (viewModel != null) {
                ...
                viewModel.fireData(message, startApp.isChecked());
            }
        });
    }
}