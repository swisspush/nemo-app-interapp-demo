package com.example.interappdemo.ui.main.broadcast;
...
public class InterAppBroadcastFragment extends DaggerFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buttonSend.setOnClickListener(v -> {
            if (viewModel != null) {
                ...
                viewModel.brodcastData(message);
            }
        });
    }
}